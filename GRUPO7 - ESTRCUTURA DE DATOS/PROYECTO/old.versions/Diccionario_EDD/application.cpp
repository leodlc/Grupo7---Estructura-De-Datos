...
int Application::initialize() {
	...
	Menu menu("Menu");
	Marquee marquee("BIENVENIDO A SU DICCIONARIO DE ESTRUCTURA DE DATOS - GRUPO 7", Console::get().get_console_size().X - 3);
	...
	menu.add_option(MenuOption("Buscar palabra: ", []() {

		}));
	menu.add_option(MenuOption("Lista de palabras ", []() {
